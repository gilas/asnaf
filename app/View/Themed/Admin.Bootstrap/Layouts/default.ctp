        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <?php echo $this->Html->link($this->Html->image('logo-small.png'), array('controller' => 'dashboards', 'action' => 'index', 'admin' => TRUE), array('class' => 'brand', 'escape' => false)); ?>
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <li><?php echo $this->Html->link('نظرات', array('controller' => 'comments', 'action' => 'index', 'admin' => TRUE)); ?></li>
                            <li class="dropdown">
